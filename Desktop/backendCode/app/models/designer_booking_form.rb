...
class DesignerBookingForm < ApplicationRecord
  has_paper_trail
  belongs_to :project

  has_attached_file :inspiration_image, default_url: "/images/:style/missing.png"
  do_not_validate_attachment_file_type :inspiration_image
end
