...
class ProjectDetail < ApplicationRecord
  ...
  PROJECT_DETAIL_INFO = YAML.load_file Rails.root.join("app","data","project_detail_info.yml")
  
  validates_inclusion_of :property_usage, in: PROJECT_DETAIL_INFO["property_usage"], allow_blank: true
