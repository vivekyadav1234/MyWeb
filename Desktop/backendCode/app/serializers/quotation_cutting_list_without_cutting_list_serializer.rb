# ###############
# Commenting as it is not being used anywhere. Remove later if still not needed.
# ###############
# class QuotationCuttingListWithoutCuttingListSerializer 
...
#         imos_manual_sheet: ContentSerializer.new(boqjob.contents.where(scope: "imos_manual_sheet")).serializable_hash,
...
#         imos_manual_sheet: ContentSerializer.new(modular_job.contents.where(scope: "imos_manual_sheet")).serializable_hash,
...
#         imos_manual_sheet: ContentSerializer.new(service_job.contents.where(scope: "imos_manual_sheet")).serializable_hash,
...
#         imos_manual_sheet: ContentSerializer.new(custom_job.contents.where(scope: "imos_manual_sheet")).serializable_hash,
...
#         imos_manual_sheet: ContentSerializer.new(appliance_job.contents.where(scope: "imos_manual_sheet")).serializable_hash,
...
#         imos_manual_sheet: ContentSerializer.new(extra_job.contents.where(scope: "imos_manual_sheet")).serializable_hash,
