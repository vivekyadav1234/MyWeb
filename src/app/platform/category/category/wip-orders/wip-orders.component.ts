...
@Component({
  selector: 'app-wip-orders',
  templateUrl: './wip-orders.component.html',
  styleUrls: ['./wip-orders.component.css'],
  providers: [CategoryService]
})
export class WipOrdersComponent implements OnInit {
