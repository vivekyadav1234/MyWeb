...
@Component({
 selector: 'app-cus-change-password',
  templateUrl: './cus-change-password.component.html',
  styleUrls: ['./cus-change-password.component.css'],

  providers:[ProfileService]
})
export class CusChangePasswordComponent implements OnInit {
