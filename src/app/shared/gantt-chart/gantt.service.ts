...
export class GanttService {
    ...
    private barStyles: IBarStyle[] = [
        { status: "not_started", backgroundColor: "#c2d6d6", border: "1px solid #669999", progressBackgroundColor: "#669999" },
        { status: "delayed", backgroundColor: "#FFA726", border: "1px solid #EF6C00", progressBackgroundColor: "#EF6C00" },
        { status: "in_progress", backgroundColor: "#b3f0ff", border: "1px solid #1ad1ff", progressBackgroundColor: "#1ad1ff" },
        { status: "completed", backgroundColor: "#66BB6A", border: "1px solid #2E7D32", progressBackgroundColor: "#2E7D32" },
        { status: "blocked", backgroundColor: "#ff9999", border: "1px solid #ff3333", progressBackgroundColor: "#ff3333" }
    ];
    public TASK_CACHE: any[];
    public TIME_SCALE: any[];

  	constructor() { 
  		let _ganttConfig = new GanttConfigService();
